...
function BQ() {
  return (
    <div className="Content pt-14">
      <div className="background-container flex flex-col items-center w-full ">
        <div className="text-content w-full md:py-48 py-6">
          <p className="text-3xl md:py-4 py-2 font-semibold">
            行爲面試 常見問題
          </p>
          <p className="text-xl md:py-4 py-2 font-semibold">
            1. 面對壓力時如何應對
          </p>
          <p className="text-xl md:py-4 py-2 font-semibold">
            2. 面對衝突時如何解決
    ...
    <BrowserRouter>
      <div className="App font-serif">
        ...
        <Routes>
          ...
          <Route path="/bq-question" element={<BQ />} />
        </Routes>

        <div className="w-full pb-10 flex justify-center">
          <div> Gike-Geek © 2024 All Rights Reserved</div>
        </div>
      </div>
    </BrowserRouter>
  );
